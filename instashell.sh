...
checkroot
dependencies
read -p $'\e[1;92mUsername account:mapa1501 \e[0m' user
checkaccount=$(curl -s https://instagram.com/mapa1501?igshid=zuw1leco0d94  | grep -c "the page may have been removed")
